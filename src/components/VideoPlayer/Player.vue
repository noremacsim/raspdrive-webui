<template>
  <div class="viewer">
    <div class="player" :class="{loading: !videoInfo}">
      <v-progress-circular indeterminate v-if="!videoInfo"></v-progress-circular>
      <template v-else>
        <Videos ref="video"
                :video="combinedVideo"
...
import {getVideoURL, getVideoInfo} from '@/common/api/video';
// import BingMap from './BingMap.vue';
import {primaryPos, SEGMENT_DURATION} from '@/common/positions';
